...
const AboutPage = () => {
  ...
  return (
    <div className="about-page">
      <Helmet>
        <title>О нашей работе - Росгвардия</title>
        <meta
          name="description"
          content="Подробная информация о службе в подразделении  вневедомственная охрана по северо западному административному округу: наши задачи, автопарк и спортивная подготовка"
        />
        <link rel="canonical" href="https://росгвардия-работа.рф/about" />
      </Helmet>
      ...
      <section className="about-section">
        ...
        <div className="unit-description">
          <p className="mission-statement">
            Специализированное подразделение ВНГ РФ выполняет задачи по охране
            общественного порядка и безопасности на объектах. Основные
          ...
          <ul className="task-list">
            <li className="task-item">
              ...
              <div className="task-h3">
                ...
                <p>
                  Круглосуточная охрана с применением современных систем
                  контроля доступа
                </p>
              </div>
            </li>
            <li className="task-item">
              ...
              <div className="task-h3">
                ...
                <p>
                  Мобильные наряды для задержания правонарушителей и пресечения
                  преступлений
                </p>
              </div>
            </li>
          ...
          <div className="team-values_h3">
            ...
            <div className="values-grid">
              <div className="value-card">
                <h4>Взаимовыручка</h4>
                <p>
                  "Сам погибай - товарища выручай" - не просто слова, а закон
                  службы
                </p>
              </div>
              <div className="value-card">
        ...
        <div className="vehicle-gallery">
          ...
          <div className="vehicle-item">
            <OptimizedImage
              src={service3}
              alt="сотрудник машина с включенными мигалками"
            />
          </div>
          <div className="vehicle-item">
          ...
          <div className="vehicle-item">
            <OptimizedImage
              src={service6}
              alt="два бегущих сотрудника и машина"
            />
          </div>
          <div className="vehicle-item">
      ...
      <section className="about-section vehicle-section">
        ...
        <div className="vehicle-description">
          <p>
            На вооружении подразделения — новейшие модели спецтранспорта,
            обеспечивающие:
          </p>
        ...
        <div className="vehicle-gallery">
          ...
          <div className="vehicle-item">
            <OptimizedImage
              src={car3}
              alt="автопарк вид с переди с водителем"
            />
          </div>
          <div className="vehicle-item">
            <LazyLoadImage
              src={car4}
              alt="машины на дороге"
              loading="lazy"
              effect="blur"
              width="100%"
              height="auto"
      ...
      <section className="about-section">
        ...
        <div className="sport-description">
          <p>
            У нас не просто работа - у нас настоящая дружба, скреплённая
            совместными тренировками и спортивными достижениями!
          </p>
          ...
          <div className="sport-highlights">
            ...
            <div className="firearm-training">
              <p>На базе современного тирового комплекса мы проводим:</p>
              ...
              <div className="training-types">
                <div className="type-card">
                  ...
                  <ul>
                    <li>
                      Практические стрельбы из пистолетов Макарова и Ярыгина
                    </li>
            ...
            <div className="highlight-item">
              ...
              <p>
                Футбольная и волейбольная команды, участвующие в ведомственных
                турнирах
              </p>
            </div>
          </div>

          <p className="sport-motto">
            "В здоровом теле - боевой дух!" - наш неофициальный девиз
          </p>
        </div>
        <div className="vehicle-gallery">
          <div className="vehicle-item">
            <LazyLoadImage
              src={sport1}
              alt="сотрудники на огневом рубеже"
              loading="lazy"
              effect="blur"
              width="100%"
              height="auto"
